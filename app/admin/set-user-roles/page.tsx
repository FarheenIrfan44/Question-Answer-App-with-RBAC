  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="container mx-auto grow p-4">
        <form className="mb-6">
          <div className="flex flex-col gap-2">
            <label htmlFor="search" className="font-bold">Search for users</label>
            <div className="flex gap-2">
              <Input id="search" name="search" type="text" defaultValue={query} className="grow" placeholder="Search by name or email..." />
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          {users.map((user) => (
            <div key={user.id} className="flex flex-col space-y-4 rounded-md bg-white p-4 shadow-md border border-gray-200">
              <div>
                <div className="text-lg font-semibold text-gray-800">
             ...
             {/* Button to change role */}
              <div className="mt-auto flex flex-wrap gap-2 pt-4 border-t">
                {['admin', 'moderator', 'contributor', 'viewer'].map((role) => (
